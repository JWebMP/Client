...
public enum Browsers
{
	...
	Browsers(CSSVersions capableCSSVersion, HTMLVersions capableHTMLVersion, double browserVersion, BrowserGroups browserGroup)
	{
		...
		htmlVersion = capableHTMLVersion;
	 ...
	 *
	 * @param name
	 * 		The name of the browser in the header file
	 * @param version
	 * 		The version of the browser in the header file
	 *
	...
	public static List<Browsers> getBrowsersForGroup(String group)
	{
		...
		{
			if (browsers1.getBrowserGroup()
			             .name()
			             .equalsIgnoreCase(groupRead))
			{
