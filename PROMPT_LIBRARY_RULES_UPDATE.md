...
- Library name: JWebMP Client
- Current/new version: 2.0.0-SNAPSHOT
- Repository URL / path: https://github.com/JWebMP/Client.git
- Rules Repository Location: generative/frontend/jwebmp/client
- Short description: The client library for the HTML application generator JWebMP
- Type:
...
- Component/topic areas (list): CRTP fluent API; Vert.x 5; GuicedEE Client; Logging; JSpecify; JWebMP Client
